...
import { ArrowRight, ExternalLink, Github, Download, BookOpen, Users, ChevronDown, FileText, Info, Calendar } from 'lucide-react';
                    ...
                    <CarouselItem key={idx}>
                      <Card className="card-interactive">
                        <div className="aspect-video overflow-hidden rounded-t-lg">
                          <iframe src="https://www.youtube.com/embed/dBPYV-hmzow?si=YzflwDIstEnW_W5E" title="YouTube video player" className="w-full h-full" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                        </div>
                        <CardHeader>
